...
map.getView().fit([-87.925215, -18.806051, -59.781318, 0.481159], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Mapa de los departamentos del Peru </h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (119 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Este mapa fue elaborado para el curso Cartografia y SIG<br />UPN-2025<br />Estudiante de Ing. Persybal Alexis Huachaca Juscamaita';
            }
